...
class MonetizationPackage extends Base\BaseObject {
  ...
  public function __construct(\Apigee\Util\APIClient $client) {
    ...
    $this->base_url = '/mint/organizations/' . rawurlencode($this->client->getOrg()) . '/monetization-packages';
  ...
  public function getPackagesWithPublishedRatePlans($developer_id) {
    $url = '/mint/organizations/' . rawurlencode($this->client->getOrg()) . '/developers/' . rawurlencode($developer_id) . '/monetization-packages?current=true&allAvailable=true';
    $this->client->get($url);
