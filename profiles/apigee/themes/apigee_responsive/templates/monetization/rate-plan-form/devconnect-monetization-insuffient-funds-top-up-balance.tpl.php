  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><?php t('You have insufficient funds to purchase plan @plan_name.', array('@plan_name' => drupal_render($form['plan_name']))); ?></p>
        <p><?php t('To purchase this plan you are required to top up your prepaid balance with at least @req_display.', array('@req_display' => drupal_render($form['required_display']))); ?><br />
