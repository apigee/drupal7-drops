...
$theme_path = drupal_get_path('theme', 'apigee_base_responsive');
include_once($theme_path . '/includes/apigee_base_responsive.inc');
 ...
 * hook_theme()
 */
function apigee_base_responsive_theme() {
  return array(
    'apigee_base_responsive_links' => array(
      'variables' => array('links' => array(), 'attributes' => array(), 'heading' => NULL),
    ),
    'apigee_base_responsive_btn_dropdown' => array(
 ...
 * @see html.tpl.php
 */
function apigee_base_responsive_preprocess_html(&$variables) {
   // Try to load the library, if the apigee_base_responsive_ui module is in use.
  if (module_exists('apigee_base_responsive_ui')) {
    $library = libraries_load('apigee_base_responsive', 'minified');
  }
}
 ...
 *
 */
function apigee_base_responsive_breadcrumb($variables) {
 ...
 * @see region.tpl.php
 */
function apigee_base_responsive_preprocess_region(&$variables, $hook) {
 ...
 * @see node.tpl.php
 */
function apigee_base_responsive_preprocess_node(&$variables) {
  if ($variables['teaser']) {
 ...
 * @see block.tpl.php
 */
function apigee_base_responsive_preprocess_block(&$variables, $hook) {
 ...
 * @see page.tpl.php
 */
function apigee_base_responsive_preprocess_page(&$variables) {
  ...
  if (module_exists('menu')) {
    ...
    $variables['tabs']['#primary'] = _apigee_base_responsive_local_tasks($variables['tabs']['#primary']);
  }
}
 ...
 */
function _apigee_base_responsive_content_span($columns = 1) {
  $class = FALSE;
 ...
 * @ingroup themeable
 */
function apigee_base_responsive_pager($variables) {
  $tags = $variables['tags'];
 ...
 * @param $hook
 */
function apigee_base_responsive_preprocess($vars, $hook) {
...
function apigee_base_responsive_form_search_form_alter(&$form, &$form_state) {
  ...
  if ($default_search == 'site') {
    ...
    unset($form['basic']);
    unset($form['action']);
    $form['#submit'] = array('apigee_base_responsive_search_form_submit');
  }
}

function apigee_base_responsive_search_form_submit($form, &$form_state) {
